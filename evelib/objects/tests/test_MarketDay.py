...
"""
    def test_get_entry_or_add_from_crest(self):
        ...
        db_item = MarketDay.get_db_item_by_crest_item(crest_item, create_if_null=True, write=True)
        self.assertEqual(db_item.name, MarketDay.get_from_db_by_id(db_item.id).name)
