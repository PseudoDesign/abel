...
class TestRegion(TestCrestSqlInterface):
    TEST_OBJECT = Region
    TESTS = {
    ...
    def test_get_empty_constellations(self):
        ...
        region = self.TEST_OBJECT.get_db_item_by_crest_item(self._connection.session, crest_item, create_if_null=True, write=True)
